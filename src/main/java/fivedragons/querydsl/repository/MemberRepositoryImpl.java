...
//                ).fetch();
    ...
    public Page<MemberTeamDto> searchPageSimple2(MemberSearchCondition condition, Pageable pageable) {
        ...
        JPQLQuery<MemberTeamDto> memberTeamDtoJPQLQuery = getQuerydsl().applyPagination(pageable, jpaQuery);
        List<MemberTeamDto> content = memberTeamDtoJPQLQuery.fetch();
        long total = memberTeamDtoJPQLQuery.fetchCount();
    ...
    public Page<MemberTeamDto> searchPageComplex(MemberSearchCondition condition, Pageable pageable) {
        ...
        return new PageImpl<>(memberTeamDtoQueryResults, pageable, total);
    }

    @Override
    public Page<MemberTeamDto> searchPageComplex_2(MemberSearchCondition condition, Pageable pageable) {
        List<MemberTeamDto> memberTeamDtoQueryResults = queryFactory
                .select(new QMemberTeamDto(
                        member.id.as("memberId"),
                        member.username,
