package fivedragons.querydsl.repository.support;
...
public abstract class Querydsl4RepositorySupport {
    ...
    public void validate() {
        Assert.notNull(entityManager, "EntityManager must be set before using Querydsl4RepositorySupport");
        Assert.notNull(querydsl, "Querydsl must be initialized before using Querydsl4RepositorySupport");
        Assert.notNull(queryFactory, "JPAQueryFactory must be initialized before using Querydsl4RepositorySupport");
    }
